...
object Uris {
    ...
    object Games {
        ...
        const val GETCURRENTTURN = "$ROOT/{gameId}/getCurrentTurn"
        const val GETCURRENTROUND = "$ROOT/{gameId}/getCurrentRound"
        const val ALL_TURNS = "$ROOT/round/{roundId}/allTurns"
